...
import co.jobsearch.Demolms.Activity.EnrollVideoCategoryActivity;
import co.jobsearch.Demolms.Activity.VideoCommentDescriptionActivity;
import co.jobsearch.Demolms.Adapter.ChannelSubCatListAdapter;
import co.jobsearch.Demolms.Adapter.ChannelVideoListAdapter;
import co.jobsearch.Demolms.Adapter.ContectDetailListByIdAdapter;
import co.jobsearch.Demolms.Adapter.CouressListByIdAdapter;
import co.jobsearch.Demolms.Adapter.MainDataRespose;
import co.jobsearch.Demolms.Adapter.PartVidetextAdapter;
import co.jobsearch.Demolms.Adapter.VideoPartsCommentAdapter;
import co.jobsearch.Demolms.Adapter.VideoPartsCommentReplayAdapter;
...
import co.jobsearch.Demolms.R;
 import co.jobsearch.Demolms.Splash.ui.Splash;
...
public enum UtilMethods {
    ...
    public void checkotp(final Context context, String contact ,final String otp,
                          final Loader loader, final Activity activity,Dialog dialog) {


        Log.e("checkotp", "contact : " +  contact +"   otp    " +otp);


        try {

            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<LoginResponse> call = git.checkotp(contact,otp);
            call.enqueue(new Callback<LoginResponse>() {

                @Override
                public void onResponse(Call<LoginResponse> call, final retrofit2.Response<LoginResponse> response) {

                    Log.e("checkotpres", "is : " + new Gson().toJson(response.body()).toString()+"   getStatus    " );
                    ...
                    if (response != null) {
                        ...
                        try {
                            ...
                            //    UtilMethods.INSTANCE.setLoginrespose(context, new Gson().toJson(response.body().getData()).toString(), "1");
                                UtilMethods.INSTANCE.myprofile(context,""+response.body().getData().getId(),loader,activity);
    ...
    public void Quizresults(final Context context, ArrayList<OtherPut> other, final Loader loader, String quiz_id,
                            final Activity activity ) {
        ...
        Log.e("Quizresults","  ,  quiz_id  :  "+  quiz_id  +"   ,   other   :    "+new Gson().toJson(other).toString()   +"       user_id    :    "+  user_id );

        try {

            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<VideoGalleryResponse> call = git.quizresults(new ResQuizPut(user_id,"11"  ,other)  );
            call.enqueue(new Callback<VideoGalleryResponse>() {

                @Override
                public void onResponse(Call<VideoGalleryResponse> call, final retrofit2.Response<VideoGalleryResponse> response) {

                    Log.e("Quizresultsres", "is : " + new Gson().toJson(response.body()).toString());
                        ...
                        try {
                            ...
                            if (response.body() != null) {
                                ...
                                if (response.body().getStatus().equalsIgnoreCase("true")) {
                                    ...
                                    UtilMethods.INSTANCE.Successfulnew(context,"Mark Percentage : "+response.body().getMark_percentage() +" \n "+""+response.body().getMessage(),5,activity);
                    ...
                    if (loader != null) {
                        if (loader.isShowing())
                            try {
                                ...
                                Log.e("Exception",    " , ExceptionF : "  +e.toString() );
                            }
                    }
 ...
 public void productpaid(final Context context, String price, String transaction_id , final String content_id,
    ...
    public void QuizDetail(final Context context,String Quiz_id,  final Loader loader  ) {


        Log.e("QuizDetail",    " , user_id : " + "user_id"   );

        try {
            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
           // Call<QuizDetailRespose> call = git.QuizDetail(Quiz_id);
            Call<QuizDetailRespose> call = git.QuizDetail("11");
            call.enqueue(new Callback<QuizDetailRespose>() {

                @Override
                public void onResponse(Call<QuizDetailRespose> call, final retrofit2.Response<QuizDetailRespose> response) {

                    Log.e("QuizDetailres", "is : " + new Gson().toJson(response.body()).toString());
                    ...
                    if (response != null) {
                        ...
                        try {
                            ...
                            if (response.body().getStatus().equalsIgnoreCase("true")  ) {
                                ...
                                FragmentActivityMessage activityActivityMessage =
                                        new FragmentActivityMessage("" + new Gson().toJson(response.body().getData()).toString(), "QuizDetail");
                                GlobalBus.getBus().post(activityActivityMessage);

                            } else {

                                UtilMethods.INSTANCE.Error(context, "No",0);
                ...
                @Override
                public void onFailure(Call<QuizDetailRespose> call, Throwable t) {
                    if (loader != null) {
                        if (loader.isShowing())
                            try {
                                loader.dismiss();
                    ...
                    if (response != null) {
                        ...
                        try {
                            ...
                            if (response.body().getStatus().equalsIgnoreCase("1") ) {
                                ...
                                UtilMethods.INSTANCE.myprofile(context,""+response.body().getData().getUser().getId(),loader,activity);
    ...
    public void UpdateContact(final Context context, final String MobileNo , final Loader loader , final Activity activity) {
        ...
        Log.e("UpdateContact",    " , MobileNo : " + MobileNo  +"  user_id  :   "+ user_id  );

        try {
            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<LoginResponse> call = git.updateContact( MobileNo ,user_id   );
            call.enqueue(new Callback<LoginResponse>() {

                @Override
                public void onResponse(Call<LoginResponse> call, final retrofit2.Response<LoginResponse> response) {

                    Log.e("UpdateContactres", "is : " + new Gson().toJson(response.body()).toString());
                    ...
                    if (response != null) {
                        ...
                        try {
                            ...
                            if (response.body().getStatus().equalsIgnoreCase("true") ) {
                                ...
                                LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                                View view = inflater.inflate(R.layout.activity_otp_verify, null);

                                final Button Cancel = (Button) view.findViewById(R.id.Cancel);
                                final Button okButton=(Button)view.findViewById(R.id.okButton);
                                final EditText otp_et=(EditText)view.findViewById(R.id.otp_et);
                                final Dialog dialog = new Dialog(context);
                                ...
                                okButton.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if(response.body().getOtp().equalsIgnoreCase(otp_et.getText().toString().trim())){
                                              ...
                                              if (UtilMethods.INSTANCE.isNetworkAvialable(context)) {
                                                ...
                                                UtilMethods.INSTANCE.UpdateContactMatchOTp(context,MobileNo, otp_et.getText().toString().trim(),
                                                        loader, activity);
      ...
      public void UpdateContactMatchOTp(final Context context, final String MobileNo, String otp , final Loader loader ,
                                        final Activity activity) {
        ...
        Log.e("UpdateContactmatcg",    " , MobileNo : " + MobileNo  +"  user_id  :   "+ user_id  );

        try {
            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<LoginResponse> call = git.updateContactVerify( MobileNo ,user_id,otp   );
            call.enqueue(new Callback<LoginResponse>() {

                @Override
                public void onResponse(Call<LoginResponse> call, final retrofit2.Response<LoginResponse> response) {

                    Log.e("UpdateContactmatcgres", "is : " + new Gson().toJson(response.body()).toString());
                    ...
                    if (response != null) {
                        ...
                        try {
                            ...
                            if (response.body().getStatus().equalsIgnoreCase("true") ) {
                                ...
                                UtilMethods.INSTANCE.setLoginrespose(context, new Gson().toJson(response.body().getData().getUser()).toString(),"123456", "1");
    ...
    public void myprofile(final Context context, final String user_id   , final Loader loader, final Activity activity) {

        Log.e("secureLoginmyprofile",    " , APIkey : " + user_id + " , password : " );
...
/*
    public void signup(final Context context, final String contact , final Loader loader, final Activity loginActivity ) {

        try {
            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<LoginResponse> call = git.signup(contact,ApplicationConstant.INSTANCE.User_id_clg);
                    ...
                    if (response != null) {
                        ...
                        try {
                            ...
                            if (response.body().getStatus().equalsIgnoreCase("true")) {
                                ...
                                Toast.makeText(context, ""+response.body().getMsg() +"  :  "+contact, Toast.LENGTH_SHORT).show();

                                LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                                View viewpop = inflater.inflate(R.layout.activity_otp_verify, null);

                                Button okButton = (Button) viewpop.findViewById(R.id.okButton);
                                Button Cancel = (Button) viewpop.findViewById(R.id.Cancel);
                                 final EditText otp_et = (EditText) viewpop.findViewById(R.id.otp_et);
                                ...
                                okButton.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if(!otp_et.getText().toString().trim().equalsIgnoreCase(response.body().getOtp())) {
                                            ...
                                            if (UtilMethods.INSTANCE.isNetworkAvialable(context)) {
                                                ...
                                                UtilMethods.INSTANCE.checkotp(context,contact,
                                                        otp_et.getText().toString().trim(),loader,loginActivity,dialog);
...
*/
    ...
    public void Editprofile(final Context context,String contact, String name ,final String email,
        ...
        Log.e("Editprofile","useridre   " +user_id+"   contact     "+contact+ "  email : "+email +
                "    middle_name    "+"middle_name"+"    emailreq    " );

        try {
            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<LoginResponse> call = git.Editprofile(  name,email,contact,ApplicationConstant.INSTANCE.User_id_clg,
                    user_id);
    ...
    public void packagecourse(final Context context, final RecyclerView recyclerchannel_video,
        ...
        Log.e("getpackageasasa",    " , course_id : "  + course_id );
        ...
        try {
            ...
            call.enqueue(new Callback<ChannelVideoResponse>() {
                ...
                public void onResponse(Call<ChannelVideoResponse> call, final retrofit2.Response<ChannelVideoResponse> response) {
                    ...
                    Log.e("getpackageasasares", "is : " + new Gson().toJson(response.body()).toString());
    ...
    PartVidetextAdapter mAdapter_content;
    ArrayList<MainDataRespose> transactionscontent = new ArrayList<>();
    DataLogin contenttransactions = new DataLogin();

    public void videoseen(final Context context, String contentid, String partid,String time ,
                          final Loader loader  ) {
        ...
        Log.e("videoseen",    " , user_id : "  + user_id +"   ,  contentid  :  "+  contentid +
                "  partid :   "+   partid  +"  ,   time  "+  time );

        try {
            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<LoginResponse> call = git.videoseen(  user_id,contentid,partid,time);
            call.enqueue(new Callback<LoginResponse>() {

                @Override
                public void onResponse(Call<LoginResponse> call, final retrofit2.Response<LoginResponse> response) {

                    Log.e("videoseenres", "is : " + new Gson().toJson(response.body()).toString());
   ...
   public void Videoopen(final Context context, String contentid, String previous_part_id,
                         final PartsChannelVideo operator, final Loader loader) {
        ...
        Log.e("videoopen",    " , user_id : "  + user_id +"   ,  contentid  :  "+  contentid+" " +
                "  ,  previous_part_id  :  "+  previous_part_id );

        try {
            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<LoginResponse> call = git.videoopen(  user_id,contentid,previous_part_id);
            call.enqueue(new Callback<LoginResponse>() {

                @Override
                public void onResponse(Call<LoginResponse> call, final retrofit2.Response<LoginResponse> response) {

                    Log.e("videoopenres", "is : " + new Gson().toJson(response.body()).toString());
                    ...
                    if (response != null) {
                        ...
                        try {
                            ...
                            if(response.body()!=null){
                                ...
                                if (response.body().getData().getOpen().equalsIgnoreCase("1")  ) {

                                    Intent i=new Intent(context, VideoCommentDescriptionActivity.class);
    ...
    public void contentdetails(final Context context, final RecyclerView recyclerchannel_video , String channel_id, final Loader loader  ) {
        ...
        Log.e("partvideodemo",    " , user_id : "  + channel_id   );

        try {
            EndPointInterface git = ApiClient.getClient().create(EndPointInterface.class);
            Call<LoginResponse> call = git.partvideodemo("4");
            call.enqueue(new Callback<LoginResponse>() {

                @Override
                public void onResponse(Call<LoginResponse> call, final retrofit2.Response<LoginResponse> response) {

                    Log.e("partvideodemores", "is : " + new Gson().toJson(response.body()).toString());
  ...
  try {
                        ...
                        if (response.body().getStatus().equalsIgnoreCase("true")  ) {
                            ...
                            String Apiresponse="" + new Gson().toJson(response.body().getData()).toString();

                            Gson gson = new Gson();
                            contenttransactions = gson.fromJson(Apiresponse, DataLogin.class);
                            transactionscontent = contenttransactions.getMain_data();

                            if (transactionscontent.size() > 0) {
                                mAdapter_content = new PartVidetextAdapter(transactionscontent, context,Apiresponse );
                                recyclerchannel_video.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false));
                                recyclerchannel_video.setItemAnimator(new DefaultItemAnimator());
...
*/
    ...
    public void SaveContentid(Context context, String Savecontent_id ) {
        SharedPreferences prefs = context.getSharedPreferences(ApplicationConstant.INSTANCE.prefNamePref, context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
         editor.putString(ApplicationConstant.INSTANCE.content_id, Savecontent_id);
         editor.commit();
